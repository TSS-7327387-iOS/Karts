...
public class CameraPlayExemple : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (CurrentFX == 0)
        {
            ...
            //{
            //    float mx = ControlFreak2.CF2Input.mousePosition.x / Screen.width;
            //    float my = ControlFreak2.CF2Input.mousePosition.y / Screen.height;
        ...
        if (CurrentFX == 1)
        {
            ...
            //if (ControlFreak2.CF2Input.GetKeyDown(KeyCode.Alpha0)) NightVisionFX = 0;
            //if (ControlFreak2.CF2Input.GetKeyDown(KeyCode.Alpha1)) NightVisionFX = 1;
            //if (ControlFreak2.CF2Input.GetKeyDown(KeyCode.Alpha2)) NightVisionFX = 2;
            //if (ControlFreak2.CF2Input.GetKeyDown(KeyCode.Alpha3)) NightVisionFX = 3;
            //if (ControlFreak2.CF2Input.GetKeyDown(KeyCode.Alpha4)) NightVisionFX = 4;
            //if (ControlFreak2.CF2Input.GetKeyDown(KeyCode.Alpha5)) NightVisionFX = 5;
            //if (ControlFreak2.CF2Input.GetKeyDown(KeyCode.Alpha6)) NightVisionFX = 6;
            //if (ControlFreak2.CF2Input.GetKeyDown(KeyCode.Alpha7)) NightVisionFX = 7;
            //if (ControlFreak2.CF2Input.GetKeyDown(KeyCode.Alpha8)) NightVisionFX = 8;
            //if (ControlFreak2.CF2Input.GetKeyDown(KeyCode.Alpha9)) NightVisionFX = 9;
            ...
            //if (ControlFreak2.CF2Input.GetKeyDown(KeyCode.DownArrow))
            //{
            //    CameraPlay.NightVision_OFF(0.5f);
        ...
        if (CurrentFX == 3)
        {
            ...
            //if (ControlFreak2.CF2Input.GetKeyDown(KeyCode.Alpha0)) DrunkFX = 0;
            //if (ControlFreak2.CF2Input.GetKeyDown(KeyCode.Alpha1)) DrunkFX = 1;
            //if (ControlFreak2.CF2Input.GetKeyDown(KeyCode.Alpha2)) DrunkFX = 2;
            //if (ControlFreak2.CF2Input.GetKeyDown(KeyCode.Alpha3)) DrunkFX = 3;
            //if (ControlFreak2.CF2Input.GetKeyDown(KeyCode.Alpha4)) DrunkFX = 4;
            //if (ControlFreak2.CF2Input.GetKeyDown(KeyCode.Alpha5)) DrunkFX = 5;
            //if (ControlFreak2.CF2Input.GetKeyDown(KeyCode.Alpha6)) DrunkFX = 6;
            //if (ControlFreak2.CF2Input.GetKeyDown(KeyCode.Alpha7)) DrunkFX = 7;
            //if (ControlFreak2.CF2Input.GetKeyDown(KeyCode.Alpha8)) DrunkFX = 8;
            //if (ControlFreak2.CF2Input.GetKeyDown(KeyCode.Alpha9)) DrunkFX = 9;
