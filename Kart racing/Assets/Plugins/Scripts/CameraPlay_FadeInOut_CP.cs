...
public partial class CameraPlay : MonoBehaviour
{
    ...
    public static void FadeInOutCS()
    {
        if (CurrentCameraCS == null) CurrentCameraCS =GameObject.FindGameObjectWithTag("CameraCS").GetComponent<Camera>() ;
        CameraPlay_FadeInOut CP = CurrentCameraCS.gameObject.AddComponent<CameraPlay_FadeInOut>() as CameraPlay_FadeInOut;
        CP.ColorFade = Color.black;
        CP.Duration = 3;
    }
