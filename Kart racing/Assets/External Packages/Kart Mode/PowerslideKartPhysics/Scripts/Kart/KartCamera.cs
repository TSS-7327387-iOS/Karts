...
namespace PowerslideKartPhysics
{
    ...
    {
        public static KartCamera instance;
        ...
        {
            MyCam.DOFieldOfView(endValue, 1.5f);
        }
        ...
        {
            transform.LookAt(targetKart.transform);
        }
        ...
        public void ShakeIt()
        {
            cameraInitialPosition = MyCam.transform.position;
        ...
        void StartCameraShaking()
        {
            ...
            Vector3 cameraIntermadiatePosition = MyCam.transform.position;
            cameraIntermadiatePosition.x += cameraShakingOffsetX;
            cameraIntermadiatePosition.y += cameraShakingOffsetY;
            MyCam.transform.position = cameraIntermadiatePosition;
        }

        public void StopCameraShaking()
        {
            CancelInvoke("StartCameraShaking");
            MyCam.transform.position = cameraInitialPosition;
        }
    }
}