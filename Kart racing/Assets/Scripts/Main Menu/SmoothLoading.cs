...
public class SmoothLoading : MonoBehaviour
{
    ...
    // Reference to the progress bar in the UI.sss
    [SerializeField]
    ...
    {
        prevState = CanvasScriptSplash.instance.currentStats;
        CanvasScriptSplash.instance.ChangeCanvas(CanvasStats.Loading);
        bg.DOAnchorPos(Vector3.zero, 1).SetEase(Ease.OutBounce);
        loadOperation = null;
        isLoading = true;
    ...
    private void Update()
    {
        //Debug.LogError("SmoothLoading is updating...");
    ...
    void ShutLoading()
    {
        ...
        {
           //  CanvasScriptSplash.instance.ChangeCanvas(prevState);
